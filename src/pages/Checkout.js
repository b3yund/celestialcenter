...
import { Elements, CardElement, useStripe, useElements } from '@stripe/react-stripe-js'; // Import necessary Stripe components
import fetchData from '../utils/fetchData';
import { AuthContext } from '../AuthContext';
import '../styles/Checkout.css';

// Initialize Stripe.js with your Publishable Key (Public Test Key)
...
const CheckoutForm = () => {
    ...
    const BACKEND_URL = 'https://celestialcentral-835108787508.us-central1.run.app'; // Hardcoded backend URL
